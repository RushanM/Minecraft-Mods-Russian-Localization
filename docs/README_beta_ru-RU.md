...
<div align="center">
    <img title="В будущем заменю эту картинку" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/preview_2.png?raw=true">
    <br>
    <br>
    <img title="Никак не связано с «Фаргус Мультимедия». Это просто добрая отсылка. Я работаю над переводами один с 2020 года, лишь изредка получая помощь от народа (хотелось бы, конечно, больше вклада от Интернета, но имеем, что имеем)." src="В будущем заменю эту картинку" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/fargus_cozy_vector.svg?raw=true" height="55">
    <a href="https://modrinth.com/mod/dynamicpack"><img title="Хороший мод, хороший разработчик ❤️" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/dynamicpack_cozy_vector.svg?raw=true" height="55"></a>
    <a href="https://modrinth.com/mod/better-resource-pack-sorting"><img title="Очень удобный мод" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/brps_cozy_vector.svg?raw=true" height="55"></a>
    <br>
    <br>
</div>
...
Меня не устраивало то, какой обычно бывает русская локализация в модах для Minecraft, и поэтому я решил сам улучшить их переводы, а также добавить перевод туда, где его нет.

Это набор ресурсов, разрабатываемый для версий Minecraft от 1.6.x до 1.21.x и поддерживающий моды под загрузчики Forge, Fabric, Quilt и NeoForge.

Помимо русского языка в наборе планируются переводы и на остальные восточнославянские и поволжские тюркские языки. Например, в некоторых версиях уже включены переводы некоторых модов на татарский и белорусский языки.
...
Помимо основного набора, проект включает переводы некоторых сборок модов. Мы локализуем файлы, которые не входят в состав отдельных модов, а относятся непосредственно к сборкам: заголовок окна, кнопки меню, квесты и другие элементы интерфейса.

Установка локализаций для этих сборок осуществляется ручной заменой соответствующих файлов сборки на версии из этого репозитория. Вы можете ознакомиться с ними и скачать по следующим ссылкам:
...
## 🔥 Моды с наибольшим запросом

Люди чаще всего просят перевести эти моды. Если готовы помочь и у вас есть опыт, добро пожаловать!

| Значок | Описание |
| :-: | :-: |
| ![Значок «Mana and Artifice»](https://cdn.modrinth.com/data/zaRGNexp/035ba5c471850838ead4165e608eaa3c8cc23cbf_96.webp) | **[Mana and Artifice](https://modrinth.com/mod/zaRGNexp)** — версия 1.20, *10 просьб* |
| ![Значок CurseForge](https://github.com/RushanM/Minecraft-Mods-Russian-Translation/raw/beta/assets/curseforge_mod_vector.svg) | **The Abyss II – The Other Side** — версия 1.20, *4 просьбы* |
| ![Значок Blood Magic](https://cdn.modrinth.com/data/PbNc6qBY/4662cc0de2f217742fe0b257ed9398244d9e298a_96.webp) | **[Blood Magic](https://modrinth.com/mod/PbNc6qBY)** — версия 1.20, *3 просьбы* |
| ![Значок CurseForge](https://github.com/RushanM/Minecraft-Mods-Russian-Translation/raw/beta/assets/curseforge_mod_vector.svg) | **Apotheosis** — версия 1.20, *3 просьбы* |
...
<a href="https://modrinth.com/resourcepack/mods-ru">
    <img height="35" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/modrinth_compact_vector.svg?raw=true">
</a>
<a href="https://www.curseforge.com/minecraft/texture-packs/mods-ru">
    <img height="35" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/curseforge_compact_vector.svg?raw=true">
<a href="https://www.planetminecraft.com/texture-pack/mods-russian-translation-6270800/">
    <img height="35" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/planet_compact_vector.svg?raw=true">
</a>
<a href="https://ru-minecraft.ru/fayly-dlya-minecraft/79004-mods-ru.html">
    <img height="35" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/rumc_compact_vector.svg?raw=true">
</a>
<a href="https://vk.com/demipr">
    <img height="35" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/assets/vk_compact_vector.svg?raw=true">
</a>
</a>
</div>
...
Версии набора ресурсов именуются согласно своей, но знакомой системе версий. Вот несколько примеров:

* `1.21-1.1` — релиз 1.1 для Minecraft 1.21.x,
* `1.21-1.1-B6` — 6-я бета релиза 1.1 для Minecraft 1.21.x,
* `1.20-1.4` — релиз 1.4 для Minecraft 1.20.x,
* `1.21-1.0-C1-B1-A300` — 300-я альфа 1-й беты 1-го кандидата на релиз 1.0 для Minecraft 1.21.x.

Запись `1.0` соответствует номеру релизной версии. Буква `B` обозначает бета-версии, буква `A` — альфа-версии. Если в конце версии стоит `A` и число, это альфа. Если номер оканчивается без буквы (например, `1.0`), это стабильный релиз.
...
<div align="center">
    <img title="Хаос, хаос!? Нет, нет! Порядок, порядок!" height="300" src="https://github.com/RushanM/Minecraft-Mods-Russian-Translation/blob/master/%D0%90%D1%81%D1%81%D0%B5%D1%82%D1%8B/1.21-1.1.png?raw=true">
</div>
...
Проект открыт для новых переводчиков, редакторов и тестировщиков. Вот как можно присоединиться:

1. Ознакомьтесь с [CONTRIBUTING_ru-RU.md](CONTRIBUTING_ru-RU.md).
2. Сообщите о своих планах в issue или Telegram, чтобы избежать дублирования.
3. Создайте перевод, упакуйте изменения и отправьте pull request. Раньше для этого нужно было целиться в ветку `alpha`, теперь используется ветка `master`.
4. Если нашли ошибку или хотите предложить улучшение формулировок, заведите тему (issue).

Верхний список наиболее востребованных модов особенно нуждается в помощи, но любые дополнения и правки приветствуются.
...
* [**Хахилин**](https://steamcommunity.com/id/xaxilin/): помогал с определением переводов и предложил переводы:
...
* [**NeCroZ**](https://minecraft-inside.ru/forum/profile/5244-necroz/): предложил переводы модов:
...
* * [Xaero's World Map](https://modrinth.com/mod/xaeros-world-map);
* [**LQMMan**](https://t.me/LQMMan): предложил переводы модов:
...
Есть личная просьба, предложение или любая другая причина обратиться лично ко мне? Вы можете написать мне в любую из сетей:

* [ВКонтакте](https://vk.com/deflecta),
* Телеграм: **`RMKHTDNV`**.

У проекта также есть [канал](http://t.me/mcmodsru) и [группа](http://t.me/mcmodsrugroup) в Telegram.

## 💝 Поддержка

Если вам нравится проект, можете оценить репозиторий звездой и рассказать о нём друзьям!
